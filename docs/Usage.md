...
See [this section](https://github.com/thelastpickle/cassandra-medusa/wiki/Performing-backups) of the wiki.
...
See [this section](https://github.com/thelastpickle/cassandra-medusa/wiki/Restoring-a-single-node) of the wiki.


Restoring a cluster
-------------------

See [this section](https://github.com/thelastpickle/cassandra-medusa/wiki/Restoring-a-full-cluster) of the wiki.
